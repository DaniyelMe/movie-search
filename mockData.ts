export const movies: MoviesApiResponse = {
  page: 1,
  per_page: 10,
  total: 112,
  total_pages: 12,
  data: [
    { Title: "Mock - Italian Spiderman", Year: 2007, imdbID: "tt2705436" },
    { Title: "Superman, Spiderman or Batman", Year: 2011, imdbID: "tt2084949" },
